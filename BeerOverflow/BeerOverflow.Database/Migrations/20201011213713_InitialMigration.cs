...
namespace BeerOverflow.Database.Migrations
{
    public partial class InitialMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "Birthday", "CreatedOn", "DeletedOn", "Email", "IsAdmin", "IsBanned", "IsDeleted", "ModifiedOn", "Name", "Password", "Username" },
                values: new object[,]
                {
                    { new Guid("3be6b2ff-021d-4da5-8639-31973b594cc5"), new DateTime(2020, 10, 12, 0, 37, 13, 209, DateTimeKind.Local).AddTicks(6724), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, "aliemail@gmail.com", true, false, false, null, "Ali", "AliPass", "AliUser" },
                    { new Guid("1d6e3bae-451f-4c01-8b43-cecc2d404270"), new DateTime(2020, 10, 12, 0, 37, 13, 209, DateTimeKind.Local).AddTicks(3931), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, "maggieemail@gmail.com", true, false, false, null, "Maggie", "MaggiePass", "MaggieUser" },
                    { new Guid("3753d26b-5a35-491f-ae82-5238d243b619"), new DateTime(2020, 10, 12, 0, 37, 13, 209, DateTimeKind.Local).AddTicks(6784), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, "telerikemail@gmail.com", false, false, false, null, "Telerik", "TelerikPass", "TelerikUser" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("bc9fa1aa-d58a-4f37-a81d-7a7ca81f27bb"), new Guid("f13cdf0f-9f3c-4435-a107-e265e016b7d3"), "It's okay I guess. Very fruity aroma. Light sour, strong sweet taste. Fruity.", new DateTime(2020, 10, 12, 0, 37, 13, 208, DateTimeKind.Local).AddTicks(4715), null, false, false, 22, null, new Guid("3753d26b-5a35-491f-ae82-5238d243b619") },
                    { new Guid("03461e43-1ebb-4035-8fa4-e5acf5c923f1"), new Guid("643db2ce-29f2-4e33-a35d-3a36b9392ba0"), "This is exellent beer!", new DateTime(2020, 10, 12, 0, 37, 13, 205, DateTimeKind.Local).AddTicks(178), null, false, false, 120, null, new Guid("3753d26b-5a35-491f-ae82-5238d243b619") },
                    { new Guid("766d9e58-68da-479c-ab97-dc9d1de06bbc"), new Guid("643db2ce-29f2-4e33-a35d-3a36b9392ba0"), "Absolutely amazing!. One of the best Bulgarian beers.", new DateTime(2020, 10, 12, 0, 37, 13, 208, DateTimeKind.Local).AddTicks(4730), null, false, false, 0, null, new Guid("1d6e3bae-451f-4c01-8b43-cecc2d404270") },
                    { new Guid("8fc141ac-8514-4545-bf57-c1e1f4078fbe"), new Guid("1855d14b-ccb6-43b8-a7b3-3936b5010293"), "I didn't really like it. Poor colour, bad taste.", new DateTime(2020, 10, 12, 0, 37, 13, 208, DateTimeKind.Local).AddTicks(4003), null, false, false, 8, new DateTime(2020, 10, 13, 0, 37, 13, 208, DateTimeKind.Local).AddTicks(4086), new Guid("3be6b2ff-021d-4da5-8639-31973b594cc5") }
                });
